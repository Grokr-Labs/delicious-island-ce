...
private let logger = Logger(subsystem: "com.deliciousisland", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.deliciousisland.agentfilewatcher", qos: .userInitiated)
