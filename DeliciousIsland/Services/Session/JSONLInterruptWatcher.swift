...
private let logger = Logger(subsystem: "com.deliciousisland", category: "Interrupt")
...
class JSONLInterruptWatcher {
    ...
    private let queue = DispatchQueue(label: "com.deliciousisland.interruptwatcher", qos: .userInteractive)
