...
actor ProcessExecutor: ProcessExecuting {
    /// Shared instance - nonisolated(unsafe) allows synchronous access from any context
    ...
    nonisolated static let logger = Logger(subsystem: "com.deliciousisland", category: "ProcessExecutor")
