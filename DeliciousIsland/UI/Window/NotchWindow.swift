...
class NotchPanel: NSPanel {
    override init(
        ...
        // Window behavior - appear on all Spaces
        // NOTE: .stationary does not work on macOS Tahoe to prevent slide animation
        // See GitHub issue for tracking this limitation
        collectionBehavior = [
            .canJoinAllSpaces,
            .fullScreenAuxiliary,
            .ignoresCycle
